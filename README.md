...
A complete DVR install has a total size of roughly 142 GB, (_this size includes the initial DVR file download from the Wabbajack software + the complete install._)
...
Latest DVR Guide Update, 01/05/2023.
