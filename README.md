...
- **Download Diabolist VR from the Wabbajack VR drop down section to begin the install process**, once that initial download is done, a new Wabbajack window will pop up, on the bottom right, now select the **Install Location (3 Dots ...)** and navigate to the DVR folder you created and the download section will automatically pick the mod folder for you inside of itself, or you can select a different folder to keep the downloaded zipped mods separate, it’s your choice.
