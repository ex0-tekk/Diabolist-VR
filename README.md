...
A complete DVR install has a total size of roughly 180 GB, (_this size includes the initial DVR file download from the Wabbajack software + the complete install._)
...
Latest DVR Guide Update, 12/05/2023.
