...
### Diabolist VR is a theme-based mod list that pays homage to the hack-n-slash loot-hoarding ARPG of the late 90s, by adding 7 Diablo inspired mods and so much more, this includes:
...
**The initial wabbajack setup file is 2.75 GB & the finished install folder size is 93 GB, for a total size of roughly 96 GB, it’s HIGHLY RECOMMENDED that you install this on a NVMe M.2 SSD for optimal performance, although traditional SSD *should* be fine.**
...
-
#### NOTE: It is HIGHLY RECOMMENDED to have Sunlight and Sky at -2, ⬇️ these settings remove excess surface and snow glare.
