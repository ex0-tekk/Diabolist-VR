...
[6]
# The Sharper Eye
#### NOTE: With SteamVR, I recommend using [The Sharper Eye](https://www.nexusmods.com/skyrimspecialedition/mods/46999/) mod with or without TAA, this mod needs to be downloaded manually and placed inside your root SkyrimVR folder, please click the link provided and read the mod page for more info, to access this window at anytime, click the HOME button, additionally, these are the settings I use for a relatively sharp image with and without TAA, performance mode is also available on the bottom right corner.
