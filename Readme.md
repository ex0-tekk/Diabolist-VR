...
**The initial wabbajack setup file is 4.77 GB & the finished install folder size is 96 GB, for a total size of roughly 101 GB, it’s HIGHLY RECOMMENDED that you install this on a NVMe M.2 SSD for optimal performance, although traditional SSD *should* be fine.**
...
- **Loot Boxes are placed at merchants across 7 different cities, they are easy to find and they *can be* addictive.**
