...
**The initial wabbajack setup file is 3.55 GB & the finished install folder size is 99 GB, for a total size of roughly 104 GB, it’s HIGHLY RECOMMENDED that you install this on a NVMe M.2 SSD for optimal performance, although traditional SSD *should* be fine.**
