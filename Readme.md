...
#### Load the game through SKSE & create a new character, once you spawn into the game it is HIGHLY RECOMMENDED to Start Recording with [MCM Recorder](https://www.nexusmods.com/skyrimspecialedition/mods/61719) before adjusting ANY of these MCM settings shown below for the best intended performance and overall compatibility. After this recording is done, your MCM settings will be saved for you to use with future new game saves and you can avoid doing these steps over and over.
